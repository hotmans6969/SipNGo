...
const STARTER_MENU: Array<{
...
}> = [
  {
    ...
    price: 400,
    category: "coffee",
    imageUrl: "https://images.unsplash.com/photo-1551030173-122aabc4489c?w=500&q=80",
  },
  {
    name: "Cappuccino",
  ...
  },
  {
    ...
    price: 600,
    category: "coffee",
    imageUrl: "https://images.unsplash.com/photo-1578314675249-a6910f80cc4e?w=500&q=80",
  },
  {
  ...
  },
  {
    ...
    price: 700,
    category: "smoothies",
    imageUrl: "https://images.unsplash.com/photo-1596755389378-c31d21fd1273?w=500&q=80",
  },
  {
    name: "Mango Smoothie",
    ...
    price: 650,
    category: "smoothies",
    imageUrl: "https://images.unsplash.com/photo-1623065422902-30a2d299bbe4?w=500&q=80",
  },
  {
    name: "Chai Latte",
  ...
  },
  {
    ...
    price: 600,
    category: "tea",
    imageUrl: "https://images.unsplash.com/photo-1536514072410-5019a3c69182?w=500&q=80",
  },
];

export async function seedMenuIfEmpty(db: Queryable): Promise<void> {
  const count = await db.one<{ count: number }>("SELECT COUNT(*) as count FROM menu_items");
  ...
  for (const item of STARTER_MENU) {
    await db.run(
      `INSERT INTO menu_items (id, name, description, price_cents, category, image_url)
       VALUES (?, ?, ?, ?, ?, ?)`,
      [uuidv4(), item.name, item.description, item.price, item.category, item.imageUrl]
    );
  }
}
